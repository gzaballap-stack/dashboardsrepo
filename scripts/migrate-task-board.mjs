// Applies supabase/migrations/add_calendar_feeds.sql to BOTH environments.
...
const sql = readFileSync(resolve(root, 'supabase/migrations/add_calendar_feeds.sql'), 'utf-8');
