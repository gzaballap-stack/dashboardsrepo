// Applies supabase/migrations/add_task_calendar_calls.sql to BOTH environments.
...
const sql = readFileSync(resolve(root, 'supabase/migrations/add_task_calendar_calls.sql'), 'utf-8');
