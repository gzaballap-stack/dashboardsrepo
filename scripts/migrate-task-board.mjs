// Applies supabase/migrations/add_task_prev_dates.sql to BOTH environments.
...
const sql = readFileSync(resolve(root, 'supabase/migrations/add_task_prev_dates.sql'), 'utf-8');
