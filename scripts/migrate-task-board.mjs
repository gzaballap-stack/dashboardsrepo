// Applies supabase/migrations/add_task_templates.sql to BOTH environments.
...
const sql = readFileSync(resolve(root, 'supabase/migrations/add_task_templates.sql'), 'utf-8');
