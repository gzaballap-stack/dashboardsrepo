// Applies supabase/migrations/small_tasks_have_no_date.sql to BOTH environments.
...
const sql = readFileSync(resolve(root, 'supabase/migrations/small_tasks_have_no_date.sql'), 'utf-8');
